...
namespace FpTron\TronAPI;

use Elliptic\EC;
use FpTron\TronAPI\Exception\TRC20Exception;
...
use FpTron\TronAPI\Support\Keccak;
use FpTron\TronAPI\Support\Utils;
use FpTron\TronAPI\Provider\HttpProviderInterface;
